...
export const PURCHASE_GAME_FAMILIES: ReadonlyArray<PurchaseGameFamily> = [
  ...
  { id: 'corpOfDiscovery', label: "Corp of Discovery", spreadsheetFamily: "Corp of Discovery", price: 40.50 },
  ...
  { id: 'fateforge', label: "Fateforge", spreadsheetFamily: "Fateforge", price: 70.00 },
  { id: 'fellowshipTrickTakingGame', label: "Fellowship Trick Taking Game", spreadsheetFamily: "Fellowship Trick Taking Game", price: 20.00 },
  ...
  { id: 'gloomOfKilforth', label: "Gloom of Kilforth", spreadsheetFamily: "Gloom of Kilforth", price: 24.49 },
  { id: 'imperialAssault', label: "Imperial Assault", spreadsheetFamily: "72 Imperial Assault", price: 51.66 },
  { id: 'imperium', label: "Imperium", spreadsheetFamily: "Imperium", price: 79.00 },
  { id: 'invincible', label: "Invincible", spreadsheetFamily: "Invincible", price: 31.89 },
  ...
  { id: 'kinfireChronicles', label: "Kinfire Chronicles", spreadsheetFamily: "Kinfire Chronicles", price: 124.99 },
  { id: 'kinfireDelve', label: "Kinfire Delve", spreadsheetFamily: "Kinfire Delve", price: 37.99 },
  ...
  { id: 'mtg', label: "MTG", spreadsheetFamily: "MTG", price: 49.99 },
  { id: 'nanolith', label: "Nanolith", spreadsheetFamily: "Nanolith", price: 99.99 },
  { id: 'nusfjord', label: "Nusfjord", spreadsheetFamily: "Nusfjord", price: 31.66 },
  ...
  { id: 'swordAndSorcery', label: "Sword and Sorcery", spreadsheetFamily: "Sword and Sorcery", price: 312.95 },
  ...
  { id: 'tamashii', label: "Tamashii", spreadsheetFamily: "Tamashii", price: 54.96 },
  { id: 'theAnarchy', label: "The Anarchy", spreadsheetFamily: "The Anarchy", price: 49.20 },
  { id: 'tidalBlades2', label: "Tidal Blades 2", spreadsheetFamily: "Tidal Blades 2", price: 65.81 },
  ...
  { id: 'unstoppable', label: "Unstoppable", spreadsheetFamily: "Unstoppable", price: 46.90 },
