...
export const PURCHASE_GAME_FAMILIES: ReadonlyArray<PurchaseGameFamily> = [
  ...
  { id: 'arkhamHorrorLcg', label: "Arkham Horror LCG", spreadsheetFamily: "Arkham Horror LCG", price: 906.23 },
  ...
  { id: 'undauntedNormandy', label: "Undaunted: Normandy", spreadsheetFamily: "Undaunted", price: 45.00 },
