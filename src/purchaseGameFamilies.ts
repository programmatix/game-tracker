...
export const PURCHASE_GAME_FAMILIES: ReadonlyArray<PurchaseGameFamily> = [
  ...
  { id: 'agemonia', label: "Agemonia", spreadsheetFamily: "Agemonia", price: 37.48 },
  {
    ...
    spreadsheetFamily: "Aeon Trespass Odyssey",
    aliases: ["Aeon Trespass Odyssey", "Aeon Tresspass Odysey"],
    objectIds: ["242705"],
    price: 222.00,
  },
  ...
  { id: 'hexploreIt', label: "Hexplore It", spreadsheetFamily: "Hexplore It", price: 180.71 },
  { id: 'hunters1492', label: "Hunters 1492", spreadsheetFamily: "Hunters 1492", price: 123.00 },
  {
    id: 'imperialAssault',
  ...
  { id: 'superPixelTactics', label: "Super Pixel Tactics", spreadsheetFamily: "Super Pixel Tactics", price: 11.04 },
  {
    id: 'swordAndSorcery',
  ...
  { id: 'terminusFrontier', label: "Terminus Frontier", spreadsheetFamily: "Terminus Frontier", price: 147.00 },
  {
    id: 'tidalBlades2',
  ...
  { id: 'twilightInscription', label: "Twilight Inscription", spreadsheetFamily: "Twilight Inscription", price: 17.99 },
  {
    ...
    spreadsheetFamily: "Undaunted",
    aliases: ["Undaunted Normandy", "Undaunted: North Africa", "Undaunted: Reinforcements"],
    price: 31.00,
  },
